...
Задание:
1. Создайте еще один контроллер, замаппленный на /car.
...
6. При запросе /car выводить весь список. При запросе /car?count=2 должен отобразиться список из 2 машин,
при /car?count=3 - из 3, и тд. При count ≥ 5 выводить весь список машин.
